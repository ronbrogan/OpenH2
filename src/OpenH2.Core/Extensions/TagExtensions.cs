...
namespace OpenH2.Core.Extensions
{
    public static class TagExtensions
    {
        public static BitmapTag GetBitmap(this ShaderTag.ShaderArguments args, H2vMap map, int? index)
        {
            ...
            if (map.TryGetTag(args.ShaderMaps[index.Value].Bitmap, out var bitm))
                return bitm;

            return null;
        }

        public static Vector4 GetInput(this ShaderTag.ShaderArguments args, int? index, Vector4 defaultValue = default)
        {
